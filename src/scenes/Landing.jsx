			...
			<div className="z-30 basis-2/5 mt-12 md:mt-32">
				...
				>
					...
					<p className="mt-10 mb-7 text-center md:text-start">
						I am a passionate web developer. I love to work on web applications using technologies like JavaScript, React,
						TypeScript, Python Axios, Express.js, Flask, SQL and Tailwind.
